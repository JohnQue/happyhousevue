       ...
       <header class="section"><c:import url="/WEB-INF/views/include/header.jsp" /></header>
        <div class="section section--feature">
            <div class="inner" style="padding:20px">
                <div class="row">
                    <form class = "w-100" method="post" action="${root}/attention/write">
                        <h1>공지사항 글 등록</h1>
                        <table class="table table-striped" style="text-align: center;">
                            <tbody>
                                <tr>
                                    <td colspan="2" style="text-align: left;"><input type="text" class="form-control" placeholder="글 제목" name="title"
                                            maxlength="50" style="width: 98%;" /></td>
                                </tr>
                                <tr>
                                    <td><textarea class="form-control" placeholder="글 내용" name="content"
                                            maxlength="2000" style="width: 100%; height: 300px;"></textarea></td>
                                </tr>
                            </tbody>
                        </table>
                        <div class="btn-group">
