										...
										<div class="form--style">
											<div id="wrapper">
													<div id="wrapper-bgbtm" style="width: 800px; margin: 0 auto;">
															<form role="form" method="post" action="${root}/member/updateComplete">
																	...
																	<div class="form-group" id="divId">
																			...
																			<div class="col-lg-10">
																					<input type="text" class="form-control onlyAlphabetAndNumber" id="id" data-rule-required="true"
																							placeholder="아이디" maxlength="30" value="${userinfo.userid}" disabled="disabled">
																			</div>
																	</div>
																	...
																	<div class="form-group" id="divName">
																			...
																			<div class="col-lg-10">
																					<input type="text" class="form-control onlyHangul" id="name" data-rule-required="true"
																							placeholder="한글만 입력 가능합니다." maxlength="15" value="${userinfo.name}" disabled="disabled">
																			</div>
																	</div>
																	<div class="form-group" id="divPhoneNumber">
																			...
																			<div class="col-lg-10">
																					<input type="tel" class="form-control onlyNumber" id="phoneNumber" data-rule-required="true"
																							name="phone" placeholder="-를 제외하고 숫자만 입력하세요." maxlength="11" value="${userinfo.phone}">
																			</div>
																	</div>
																	<div class="form-group" id="divEmail">
																			...
																			<div class="col-lg-10">
																					<input type="email" class="form-control" id="email" data-rule-required="true" placeholder="이메일"
																							name="email" maxlength="40" value="${userinfo.email}">
																			</div>
																	</div>
