...
<body>
		<div class="body__container">
				...
				<section class="section section--visual healthcenter">
						<div class="inner">
								<div class="summary">
										<h2 class="summary__title">HEALTH CENTER</h2>
										<p class="summary__description">코로나 선발진료소 정보</p>
								</div>
								<div id="sign-form">
										<ul>
				...
				<section class="section--feature" style="padding-top: 40px;">
						<h1 style="font-size: 2rem; text-align: center; margin-bottom: 20px;">코로나 선발진료소 리스트</h1>
															...
															success : function(data) {
																...
																$.each(data, function(index, vo) {
																	let str = "<tr class=" + colorArr[index % 3]
																			...
																			+ vo.address + "</td>" + "<td>"
																			+ vo.oponweek + "</td>" + "<td>"
																			+ vo.oponweekend + "</td>" + "<td>"
																			+ vo.oponholiday + "</td>" + "<td>"
																			+ vo.tel + "</td></tr>";
																	$(".tbody").append(str);
																});//each
															},
